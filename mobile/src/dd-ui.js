...
export class LabeledTextInput extends Component {
  ...
  render() {
    const labelColor =
      this.props.style != null && this.props.style.labelColor != null
        ? this.props.style.labelColor
        : '#AAAAAA'
    const labelMarkColor =
      this.props.style != null && this.props.style.labelMarkColor != null
        ? this.props.style.labelMarkColor
        : '#FF0055'
    return (
      <View
        style={[
          { backgroundColor: '#FFFFFF', marginBottom: 2, height: 48, paddingTop: 4 },
          this.props.style,
        ]}
      >
        <TextInput
          ...
          onEndEditing={() => this.onFocusChange()}
    ...
    return (
      <TouchableOpacity onPress={this.props.onPress} style={[{ flex: 1 }, passInStyles]}>
        ...
        >
          ...
          <Text style={{ color, textAlign: 'center', marginBottom: 3, padding: 8 }}>
            {this.props.title}
          </Text>
        </View>
        <View
          style={{ height: 2, backgroundColor: 'rgba(0,0,0,0.1)', marginLeft: 4, marginRight: 4 }}
        />
      </TouchableOpacity>
    )
  }
